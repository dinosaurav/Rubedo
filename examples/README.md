...
| [`ray_executor`](ray_executor/) | local Ray cluster (optional install) | expand → map → reduce | same external-executor shape as Dask, with a thin `ObjectRef.future()` pool adapter |
