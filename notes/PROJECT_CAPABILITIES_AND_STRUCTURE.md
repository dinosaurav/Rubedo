...
10. **Web UI:** A React + Vite dashboard for browsing runs, outputs, and lineage. It is purely read-only. Runs and invalidations are triggered from library code (`rubedo.run` and `rubedo.invalidate`), not the UI.
